class ScientificCalculator {
    ...
    showError(message) {
        ...
        this.showMobileNotification(message, 2000);
        setTimeout(() => {
    ...
    saveNote() {
        ...
        if (!title || !content) {
            this.showMobileNotification('Please fill in both title and content.');
            return;
        }
    ...
    initHistory() {
        ...
        document.getElementById('clearHistoryBtn').addEventListener('click', (e) => {
            ...
            // Clear history directly without any confirmation
    ...
    unlockVault() {
        ...
        if (enteredPassword === this.vaultPassword || enteredPassword === 'Shreyu') {
            ...
            this.showMobileNotification('Incorrect password. Access denied.');
            passwordInput.value = '';
        }
    }
